...
Vemos algunas caracteristicas  de unas variables con la  función summary
...
ggplot( aes(x="", y=n, fill=Lenght_campaing))+
  geom_bar(width = 1, stat = "identity")+ ggtitle("Succesful Campaings") + theme_void() + coord_polar("y", start=0)+geom_label_repel(aes(label = prop), size=5, show.legend = F, nudge_x = 1)
...
pieFailed%>%
  ...
  mutate(prop = percent(n / sum(n)))%>%
ggplot( aes(x="", y=n, fill=Lenght_campaing))+
  geom_bar(width = 1, stat = "identity")+ ggtitle("Failed Campaings") + theme_void() + coord_polar("y", start=0)+geom_label_repel(aes(label = prop), size=5, show.legend = F, nudge_x = 1)
...
piecancel%>%
  ...
  mutate(prop = percent(n / sum(n)))%>%
  ggplot( aes(x="", y=n, fill=Lenght_campaing))+
  geom_bar(width = 1, stat = "identity")+ ggtitle("Cancel Campaings") + theme_void() + coord_polar("y", start=0)+geom_label_repel(aes(label = prop), size=5, show.legend = F, nudge_x = 1)
...
pie1%>%
  ...
  geom_bar(width = 1, stat = "identity")+ ggtitle("Group 1") + theme_void() + coord_polar("y", start=0)+geom_label_repel(aes(label = prop), size=5, show.legend = F, nudge_x = 1)
#head(pie1)
...
pie2%>%
  ...
  mutate(prop = percent(n / sum(n))) %>%
  ggplot( aes(x="", y=n, fill=state))+
  geom_bar(width = 1, stat = "identity")+ ggtitle("Group 2") + theme_void() + coord_polar("y", start=0)+geom_label_repel(aes(label = prop), size=5, show.legend = F, nudge_x = 1)
...
pie3%>%
  ...
  mutate(prop = percent(n / sum(n))) %>%
  ggplot( aes(x="", y=n, fill=state))+
  geom_bar(width = 1, stat = "identity")+ ggtitle("Group 3") + theme_void() + coord_polar("y", start=0)+geom_label_repel(aes(label = prop), size=5, show.legend = F, nudge_x = 1)
...
pie4%>%
  ...
  mutate(prop = percent(n / sum(n))) %>%
  ggplot( aes(x="", y=n, fill=state))+
  geom_bar(width = 1, stat = "identity")+ ggtitle("Group 4") + theme_void() + coord_polar("y", start=0)+geom_label_repel(aes(label = prop), size=5, show.legend = F, nudge_x = 1)
...
pie5%>%
  ...
  mutate(prop = percent(n / sum(n))) %>%
  ggplot( aes(x="", y=n, fill=state))+
  geom_bar(width = 1, stat = "identity")+ ggtitle("group 5") + theme_void() + coord_polar("y", start=0)+geom_label_repel(aes(label = prop), size=5, show.legend = F, nudge_x = 1)
...
pie6%>%
  ...
  mutate(prop = percent(n / sum(n))) %>%
  ggplot( aes(x="", y=n, fill=state))+
  geom_bar(width = 1, stat = "identity")+ ggtitle("Group 6") + theme_void() + coord_polar("y", start=0)+geom_label_repel(aes(label = prop), size=5, show.legend = F, nudge_x = 1)
...
pie7%>%
  ...
  mutate(prop = percent(n / sum(n))) %>%
  ggplot( aes(x="", y=n, fill=state))+
  geom_bar(width = 1, stat = "identity")+ ggtitle("Group 7") + theme_void() + coord_polar("y", start=0)+geom_label_repel(aes(label = prop), size=5, show.legend = F, nudge_x = 1)
...
#### función de distribución empírica dell objetivo de las campañas exitosas
...
emp1<-ks5 %>% filter(goal<1000)
 ...
 emp1%>% count(state) %>% mutate(prop = percent(n / sum(n))) %>% ggplot(aes(x="", y=n, fill=state))+ geom_bar(width = 1, stat = "identity")+ ggtitle("Group 1: <= 1000 (USD)") + theme_void() + coord_polar("y", start=0)+geom_label_repel(aes(label = prop), size=5, show.legend = F, nudge_x = 1) 
...
emp2<-ks5 %>% filter(goal>1000 &goal<=10000)
 ...
 emp2%>% count(state) %>% mutate(prop = percent(n / sum(n))) %>% ggplot(aes(x="", y=n, fill=state))+ geom_bar(width = 1, stat = "identity")+ ggtitle("Group 1: <= 1000 (USD)") + theme_void() + coord_polar("y", start=0)+geom_label_repel(aes(label = prop), size=5, show.legend = F, nudge_x = 1) 
...
emp3<-ks5 %>% filter(goal>10000 &goal<=100000)
 ...
 emp3%>% count(state) %>% mutate(prop = percent(n / sum(n))) %>% ggplot(aes(x="", y=n, fill=state))+ geom_bar(width = 1, stat = "identity")+ ggtitle("Group 3: 10000<x<100000 (USD)") + theme_void() + coord_polar("y", start=0)+geom_label_repel(aes(label = prop), size=5, show.legend = F, nudge_x = 1) 
...
emp4%>% count(state) %>% mutate(prop = percent(n / sum(n))) %>% ggplot(aes(x="", y=n, fill=state))+ geom_bar(width = 1, stat = "identity")+ ggtitle("Group 4 : > 100000 (USD)") + theme_void() + coord_polar("y", start=0)+geom_label_repel(aes(label = prop), size=5, show.legend = F, nudge_x = 1) 
...
# ggplot(ks8,aes(diferencia_1)) + stat_ecdf(geom = "step")
